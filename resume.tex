...
\cvheadingstart
  \cvcompany{Lyft Inc.}{New York, NY}
    \cvrole{\textbf{Software Engineer, Production Infrastructure \& Marketplace Forecasting}}{11/2021 - Present}
        \cvproject{Forecasting Platform: Scaled marketplace forecasting to support models 50x larger than the previous maximum.}{}
        \cvitemstart
          \cvitem{Delivered two flagship forecasting models powering marketplace pricing, expanding model granularity 50x and serving 7 features from a single model where each prior model served one.}
