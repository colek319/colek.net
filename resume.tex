...
\linespread{1.05}  %!p(string=Software engineer with 5 years of experience building and maintaining production distributed systems. Enjoys working working full stack, and on systems with scale.)alladio needs more leading (space between lines)
...
\footnotesize
\textbf{Summary:} Software engineer with 5 years of experience building and maintaining production distributed systems. Enjoys working working full stack, and on systems with scale.
\end{minipage}
