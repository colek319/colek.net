...
\linespread{1.05}  %!p(string=Software developer with 5 years of experience in full-stack programming and cloud architectures, migrations, and operations. Improves and debugs large scale systems while minimizing user disruptions.)alladio needs more leading (space between lines)
...
\cvheadingstart
  \cvcompany{Lyft Inc.}{New York, NY}
    \cvrole{\textbf{Software Engineer, Marketplace Forecasting}}{12/2024 - Present}
        \cvproject{Demand by Distance Buckets: Bucketize demand outputs for better pricing adjustments.}{}
        \cvitemstart
          \cvitem{Added multiple layers of bucketization in forecasts, enabling more granular pricing adjustments.}
          \cvitem{Implemented arbitrary nesting layers in forecast sinking client.}
          \cvitem{Worked with scientists and platform engineers to address scaling challenges due to exponentially increasing number of rows. E.g. compression, proxy size limits, and pruning near zero values.}
        \cvitemend
        \cvproject{Forecasting Latency SLOs: Add latency and availability SLOs on the forecasting platform.}{}
        \cvitemstart
          \cvitem{Aligned latency metrics across key segments in data pipeline.}
          \cvitem{Added alarms on latency and availability, increasing team accountability and visibility into regression.}
        \cvitemend
    \cvrole{\textbf{Software Engineer, Production Infrastructure}}{11/2021 - 12/2024}
        \cvproject{Zone Aware Routing: Improved intra availability zone routing with ROI of \$2 million.}{}
        \cvitemstart
          \cvitem{Reduced inter-AZ production traffic by 40\%.}
